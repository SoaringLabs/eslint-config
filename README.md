# @soaring-labs/eslint-config

[![npm](https://img.shields.io/npm/v/@soaring-labs/eslint-config?color=444&label=)](https://npmjs.com/package/@soaring-labs/eslint-config)
